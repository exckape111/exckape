...
const labels={"Spread":"растекание","Wear":"износ","Pixel size":"размер пикселя","Dot spacing":"расстояние между точками","Misregistration":"смещение печати","Grain":"зерно","Character size":"размер символа","Threshold":"порог","Streak length":"длина штриха","Block size":"размер блока","Tonal levels":"уровни тона","Line spacing":"расстояние между линиями","Line weight":"толщина линии","Sensitivity":"чувствительность","Tracking distortion":"искажение трекинга","Scanlines":"строки развертки","Grain amount":"количество зерна","Contrast":"контраст","Speckle":"крапинки","Fade":"выцветание","Paper grain":"зерно бумаги","Dither":"дизеринг","Print wear":"износ печати","Heat shift":"сдвиг тепла","Exposure":"экспозиция","Print grain":"зерно печати","Pane width":"ширина панели","Refraction":"преломление","Wave spacing":"расстояние волн","Distortion":"искажение","Trail length":"длина следа","Strength":"сила","Stripe spacing":"расстояние полос","Stripe depth":"глубина полос","Weave size":"размер плетения","Thread texture":"текстура нитей","Ink threshold":"порог чернил","Grit":"шероховатость","Ink pressure":"давление чернил","Relief depth":"глубина рельефа","Surface grain":"зерно поверхности","Dot density":"плотность точек","Dot size":"размер точки","Dot weight":"вес точки","Warmth":"теплота","Film grain":"зерно плёнки","Movement":"движение","Angle":"угол","Ghost exposure":"призрачная экспозиция","Exposure adjustment":"коррекция экспозиции","Tonal contrast":"тональный контраст"};
for(const [, ,knobs] of defs)knobs.push(['toneExposure','коррекция экспозиции',0,-60,60],['contrastTune','тональный контраст',0,-60,60]);
